...
const features = [
  {
    title: 'Cuts the invoice off, properly',
    body: 'Finds the TAX INVOICE band on each page and cuts just above it. The band does not sit in the same place on every label, which is why tools that cut at a fixed offset leave a black strip along the bottom.',
  },
  {
    title: 'Removes the invoice, not just hides it',
    body: 'The label is re-drawn into a new page through a clipped form, so the invoice is not in the output file at all. Shrinking the page box, the usual shortcut, leaves your GSTIN and the buyer\u2019s billing address inside the PDF you hand to a packer.',
  },
  {
    title: 'A real 4x6, and a 4-up A4',
    body: 'Exactly 288 by 432 points for a thermal roll, a 6x4 landscape version, or four labels arranged two by two on one A4 sheet. Or keep the label at its own size with the invoice gone.',
  },
  {
